...
jQuery(document).ready(function(){
    ...
    scaleFactor = canvasObject.initializeScaling('.\TYPO3\CMS\Core\Utility\GeneralUtility::makeInstance('tx_imagemapwizard_model_typo3env')->getExtConfValue('imageMaxWH',700).');
